...
class OfficePage extends StatefulWidget {
  const OfficePage({super.key, required Null Function() onBack, required   onBackToExplore});
...
class _OfficePageState extends State<OfficePage> {
  ...
  Future<String?> uploadImage() async {
    ...
    await supabase.storage.from('rent_images').upload('office/$fileName', file);

    return supabase.storage.from('rent_images').getPublicUrl('office/$fileName');
  }
  ...
  Future<void> addPostDialog() async {
    ...
    final ok = await showDialog<bool>(
      ...
      builder: (_) => AlertDialog(
        ...
        title: const Text("Add Office Rent", style: TextStyle(color: tealDark)),
