...
class _HostelPageState extends State<HostelPage> {
  ...
  Future<String?> uploadImage() async {
    ...
    await supabase.storage.from('rent_images').upload('hostel/$fileName', file);

    return supabase.storage.from('rent_images').getPublicUrl('hostel/$fileName');
  }
  ...
  Future<void> addPostDialog() async {
    ...
    final ok = await showDialog<bool>(
      ...
      builder: (_) => AlertDialog(
        ...
        title: const Text("Add Hostel Rent", style: TextStyle(color: tealDark)),
