...
class HostelPage extends StatefulWidget {
  ...
  const HostelPage({super.key, required this.onBackToExplore});
...
class _HostelPageState extends State<HostelPage> {
  ...
  final List<_RentPost> posts = [
    _RentPost(
      title: "Hostel Seat (Shared)",
      location: "Uttara Sector 7, Dhaka",
      price: "৳ 3,500 / month",
      distance: "8.10 km",
      image: "image/hostel-icon.jpg",
    ),
    _RentPost(
      title: "Hostel Seat (Single)",
        ...
        content: SingleChildScrollView(
          child: Column(
            children: [
              ...
              TextField(controller: priceC, decoration: const InputDecoration(labelText: "Price (e.g. ৳ 3500 / month)")),
              TextField(controller: distC, decoration: const InputDecoration(labelText: "Distance (e.g. 8.1 km)")),
            ],
          ),
        ),
        actions: [
    ...
    if (res == true) {
      setState(() {
        posts.insert(
          0,
          _RentPost(
            title: titleC.text.trim().isEmpty ? "Hostel Seat" : titleC.text.trim(),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Hostel Rentals", style: TextStyle(color: oceanDark, fontWeight: FontWeight.w900)),
        actions: [
